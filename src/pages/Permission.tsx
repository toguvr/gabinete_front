...
import { PermissionByIdDTO, RoleDTO, StateProps, UserDTO } from '../dtos';
...
export default function Permission() {
  ...
  console.log('dateToFilter', dateToFilter, 'filterField', filterField);
                  ...
                  switch (selectFilter) {
                    ...
                    case 'birthdate':
                      if (filterField?.length >= 3) {
                        return (
                          getFormatDate(
                            addHours(new Date(currentValue?.user?.birthdate), 12),
                            'dd/MM/yyyy'
                    ...
                    <Tr key={permission.id} h="45px" py="4px">
                      ...
                      >
                        {permission?.user?.birthdate
                          ? getFormatDate(
                              addHours(new Date(permission?.user?.birthdate), 12),
                              'dd/MM/yyyy'
                            )
                          : '-'}
                      </Td>
